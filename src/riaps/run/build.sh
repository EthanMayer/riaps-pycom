...
python3.9 setup.py build_ext -b . -t ./build

# Compile C code
echo "====Compiling C code...===="
clang -fno-common -dynamic -DNDEBUG -g -fwrapv -O3 -Wall -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk -I /opt/homebrew/Cellar/zeromq/4.3.4/include -I /opt/homebrew/Cellar/python@3.9/3.9.16/Frameworks/Python.framework/Versions/3.9/include/python3.9 -c TEST_funcBody.c -o build/TEST_funcBody.o
